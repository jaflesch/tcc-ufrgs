...
A Tabela \ref{tabelaAvalTrabFinal} apresenta um comparativo das principais características dos quatro trabalhos relacionados com uma nova coluna referente ao Portal de Vagas.

 \begin{landscape}  
    \begin{table}[h]
        \begin{center}
        \caption{Tabela comparativa sobre os trabalhos relacionados e o Portal de Vagas.}
        \begin{tabular}{l|l|l|l|l|>{\columncolor{tableblue!30}}l}
        \hline
        \rowcolor{tableblue}
                            & \textbf{PDGEP}  & \textbf{SGEEO}    & \textbf{LKDIN}& \textbf{MB} & \textbf{PDV}\\
        \hline
        \textit{Software}   & Sistema         & Sistema           & Rede social   & Sistema & Rede social \\
        Oferta              & Estágios        & Estágios, empregos &Estágios, empregos & Bolsas & Todas opções \\
        Login               & Sim             & Sim               & Sim           & Sim     & Sim \\
        Enviar currículo    & Não             & Sim               & Sim           & Não     & Sim \\
        Pesquisar vagas     & Sim             & Sim               & Sim           & Sim     & Sim \\
        Pesquisar usuários  & Empresas        & Parceiros         & Sim           & Não     & Sim \\
