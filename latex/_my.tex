...
Ao final deste processo, a implementação do banco de dados da rede social foi concluído com X tabelas, sendo elas:
...
\begin{itemize}
    ...
    \item \textbf{follow}
    \item \textbf{job}
    \item \textbf{job\_apply}
    \item \textbf{job\_category}
    \item \textbf{log}
    \item \textbf{post}
    \item \textbf{post\_like}
    \item \textbf{recommendation\_job}
    \item \textbf{recommendation\_user}
    \item \textbf{user}
    \item \textbf{user\_education}
    \item \textbf{user\_job}
    \item \textbf{user\_language}
    \item \textbf{user\_skill}
    \item \textbf{user\_timeline}
\end{itemize}
