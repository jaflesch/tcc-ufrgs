...
\begin{figure}[h]
    \caption{Tela de \textit{login} do Portal de Vagas.}
        \begin{center}
            \includegraphics[width=0.68\textwidth]{figuras/tela_login.png}
        \end{center}
    \label{telaLoginImg}
    \legend{Fonte: Autor}
\end{figure}
...
\begin{figure}[ht]
    \caption{Tela de Configurações gerais do Portal de Vagas.}
        \begin{center}
            \includegraphics[width=0.68\textwidth]{figuras/config_01.png}
        \end{center}
...
\begin{figure}[h]
    \caption{Tela de Registro de atividades do Portal de Vagas.}
        \begin{center}
            \includegraphics[width=0.68\textwidth]{figuras/config_03.png}
        \end{center}
    \label{telaConfigLog}
    \legend{Fonte: Autor}
\end{figure}
...
\begin{figure}[h]
    \caption{Tela de Configurações de privacidade do Portal de Vagas.}
        \begin{center}
